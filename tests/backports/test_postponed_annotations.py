...
from fastapi_backports._backports.postponed_annotations import PostponedAnnotationsBackporter
...
@skip_if_backport_not_needed(PostponedAnnotationsBackporter)
